...
f_go = open('GO.scm', 'a')
#f_go.write("(clear)\n")
f_go.write("(define count (count-all))\n")
f_go.write("(define message (string-append \" Atoms loaded \" \"\\n\"))\n")
f_go.write("(display count)\n")
f_go.write("(display message)\n")
#start iteration
i = 0 ; 
f_go.write("(define start_time (current-time))\n")
...
while i < len(line_no):
 ...
 i= i + 1
#close file
f_go.write("(define end_time (current-time))\n")
#f_go.write("(define elapsed_time (round (/ (- end_time start_time) 60.0)))\n")
f_go.write("(define elapsed_time (/ (- end_time start_time) 60.0))\n")
f_go.write("(set! count (count-all))\n")
f_go.write("(display count)\n")
f_go.write("(display message)\n")

f_go.write("(display \"Atom loading End in .....\")\n")
f_go.write("(display elapsed_time)\n")
f_go.write("(display \" minutes\\n\")\n")
f_go.close()
